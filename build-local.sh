...
docker run -ti --name swarmlab-antora  -v $PWD/docs:/antora -v $PWD:/doc-repo hub.swarmlab.io:5480/antora  /bin/sh -c "export NODE_PATH=/usr/lib/node_modules:$NODE_PATH exec sh -c 'build.sh'"
